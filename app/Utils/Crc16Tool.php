...
//        return (chr($uchCRCLo) . chr($uchCRCHi));
        return dechex(($uchCRCHi << 8) | $uchCRCLo);

    }

    public static function checksum($filebin)
    {
        set_time_limit(0);
        //V -- 无符号长整数 (32位, 小端字节序高字节左)
        $final_sum = '';
        ...
        fclose($file);
        $final_sum = strtoupper(substr(dechex($sum), -8));
        return $final_sum;
    }
